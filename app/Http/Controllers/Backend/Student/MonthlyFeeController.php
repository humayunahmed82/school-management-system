...
class MonthlyFeeController extends Controller
{
    ...
    public function MonthlyFeeClassData(Request $request){
        ...
        foreach ($allStudent as $key => $v) {
            ...
            $html[$key]['tdsource'] .='<a class="text-'.$color.'" title="PaySlip" data-bs-tooltip="tooltip" data-bs-placement="top"  target="_blanks" href="'.route("student.monthly.fee.payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'$month='.$request->month.'"><i class="lni lni-printer"></i></a>';
            $html[$key]['tdsource'] .= '</td>';
