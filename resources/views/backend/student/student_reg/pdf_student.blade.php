	...
	<body>
		...
		<div class="invoice-box">
			...
			<table>
				...
				<tr class="item">
					<td width="10%">2</td>
					<td width="45%"> <strong>Student ID No</strong> </td>
					<td width="45%">{{ $details['student']['id_no'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">3</td>
					<td width="45%"> <strong>Student Roll</strong> </td>
				...
				<tr class="item">
					...
					<td width="45%">{{ $details['student']['m_name'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">6</td>
					<td width="45%"> <strong>Mobile Number</strong> </td>
					<td width="45%">{{ $details['student']['mobile'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">7</td>
					<td width="45%"> <strong>Address</strong> </td>
					<td width="45%">{{ $details['student']['address'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">8</td>
					<td width="45%"> <strong>Gender</strong> </td>
					<td width="45%">{{ $details['student']['gender'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">9</td>
					<td width="45%"> <strong>Religion</strong> </td>
					<td width="45%">{{ $details['student']['religion'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">10</td>
					<td width="45%"> <strong>Date of Birth</strong> </td>
					<td width="45%">{{ $details['student']['dob'] }}</td>
				</tr>
				<tr class="item">
					<td width="10%">11</td>
					<td width="45%"> <strong>Discount</strong> </td>
					<td width="45%">{{ $details['discount']['discount'] }}%</td>
				</tr>
				<tr class="item">
					<td width="10%">12</td>
