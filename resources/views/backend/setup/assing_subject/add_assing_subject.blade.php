...
<div class="card-style mb-30">
    <h6 class="mb-25">Add New Assing Subject</h6>
    ...
    <form action="{{ route('store.assing.subject') }}" method="POST">
        ...
        <div class="input-style-1">
            <button type="submit" class="main-btn primary-btn rounded-full btn-hover">Add Assing Subject</button>
        </div>
    </form>
</div>
