    ...
    <div class="col-lg-12">
        <div class="card-style">
            ...
            <div class="title pb-30 d-flex border-bottom flex-wrap gap-3 align-items-center justify-content-between">
                <div class="left">
                    <h4 class="text-medium">Assing Subject List</h4>
                </div>
                <div class="right">
                    <a href="{{ route('assing.subject.add') }}" class="main-btn success-btn rounded-full btn-hover">Add Assing Subject</a>
                </div>
            </div>
            <!-- End Title -->
                ...
                <table class="table top-selling-table" id="example">
                    <thead>
                        <tr>
                            ...
                            <th class="min-width">
                                <h6 class="text-sm text-medium">Assing Subject</h6>
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-sm">{{ $assing['student_classes']['name'] }}</p>
                            </td>
                            <td width="10%">
