            ...
            <ul>
                ...
                <li class="nav-item {{ ($prefix == '/setups')? 'active':'' }} nav-item-has-children">
                    ...
                    <ul id="ddmenu_3" class="collapse dropdown-nav {{ ($prefix == '/setups')? 'show':'' }}">
                        ...
                        <li>
                            <a class="{{ ($route == 'designation.view')? 'active':'' }}" href="{{ route('designation.view') }}">Designation</a>
                        </li>
                    </ul>
                </li>

                <li class="nav-item {{ ($prefix == '/students')? 'active':'' }} nav-item-has-children">
                    ...
                    <ul id="ddmenu_4" class="collapse dropdown-nav {{ ($prefix == '/students')? 'show':'' }}">
                        ...
                        <li>
                            <a class="{{ ($route == 'roll.generate.view')? 'active':'' }}" href="{{ route('roll.generate.view') }}">Roll Generate</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="{{ ($route == 'exam.fee.view')? 'active':'' }}" href="{{ route('exam.fee.view') }}">Exam Fee</a>
                        </li>
                    </ul>
                </li>

                <li class="nav-item {{ ($prefix == '/employees')? 'active':'' }} nav-item-has-children">
                    ...
                    <ul id="ddmenu_5" class="collapse dropdown-nav {{ ($prefix == '/employees')? 'show':'' }}">
                        <li>
                            <a class="{{ ($route == 'employee.regitration.view')? 'active':'' }}" href="{{ route('employee.regitration.view') }}">Employee Registration</a>
                        </li>
                    </ul>
                </li>
